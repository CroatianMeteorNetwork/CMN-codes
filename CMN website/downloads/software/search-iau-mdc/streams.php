...
<?php
    // if True, once a day the IAU file will be copied locally and that copy will be used, if False, it will use the IAU file directly
    $use_local_file=False; 
    
    date_default_timezone_set('Europe/Zagreb');
    $url='http://www.ta3.sk/IAUC22DB/MDC2007/Etc/streamfulldata.csv';   
    $filename = 'streamfulldata.csv';
    echo "<p>";    
    if ($use_local_file){
      echo "Checking file... ";    
